...
double compute_lil_het(suff_stat &ss, int &nid, double &sigma, data_info &di, tree_prior_info &tree_pi);
double compute_lil_mu_het(suff_stat &ss, int &nid, double &sigma, data_info &di, tree_prior_info &tree_pi);
double compute_lil_tau_het(suff_stat &ss, int &nid, double &sigma, data_info &di, tree_prior_info &tree_pi);
